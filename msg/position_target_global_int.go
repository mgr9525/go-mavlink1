...
func Byte2PosTargetGlobalInt(bts *[]byte) *PosTargetGlobalInt {
	sct := *(**PosTargetGlobalInt)(unsafe.Pointer(bts))
	ret := *sct
	return &ret
}
func PosTargetGlobalInt2Byte(sct *PosTargetGlobalInt) *[]byte {
